...
export interface AIProvider {
  analyzeText(systemPrompt: string, userPrompt: string, options?: {
    temperature?: number;
    maxTokens?: number;
    jsonMode?: boolean;
  }): Promise<string>;
...
export function createAIProvider(config: {
  ...
  throw new Error('No AI provider API key configured. Please set either GEMINI_API_KEY or OPENAI_API_KEY');
}